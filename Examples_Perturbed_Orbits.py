...
body_settings.add_empty_settings("Delfi-n3Xt")
...
body_settings.get("Delfi-n3Xt").aerodynamic_coefficient_settings = aero_coefficient_settings
...
body_settings.get("Delfi-n3Xt").radiation_pressure_target_settings = vehicle_target_settings

bodies = environment_setup.create_system_of_bodies(body_settings)
bodies.get("Delfi-n3Xt").mass = 3.0 #kg

# Define bodies that are propagated
bodies_to_propagate = ["Delfi-n3Xt"]
...
acceleration_settings = {"Delfi-n3Xt": accelerations_settings_delfi_c3}
...
simulation_end_epoch   = DateTime(2035, 2, 13).epoch()

# Retrieve the initial state of Delfi-n3Xt using Two-Line-Elements (TLEs)
delfi_tle = environment.Tle(
    "1 39428U 13066N   14006.68509259  .00001279  00000-0  14604-3 0  9994",
    "2 39428  97.7994  67.4392 0013366   3.7836 356.3353 14.87859091309945"
)
...
dependent_variables_to_save = [
    propagation_setup.dependent_variable.total_acceleration("Delfi-n3Xt"),
    propagation_setup.dependent_variable.keplerian_state("Delfi-n3Xt", "Earth"),
    propagation_setup.dependent_variable.latitude("Delfi-n3Xt", "Earth"),
    propagation_setup.dependent_variable.longitude("Delfi-n3Xt", "Earth"),
    propagation_setup.dependent_variable.single_acceleration_norm(
        propagation_setup.acceleration.point_mass_gravity_type, "Delfi-n3Xt", "Sun"
    ),
    propagation_setup.dependent_variable.single_acceleration_norm(
        propagation_setup.acceleration.point_mass_gravity_type, "Delfi-n3Xt", "Moon"
    ),
    propagation_setup.dependent_variable.single_acceleration_norm(
        propagation_setup.acceleration.point_mass_gravity_type, "Delfi-n3Xt", "Mars"
    ),
    propagation_setup.dependent_variable.single_acceleration_norm(
        propagation_setup.acceleration.point_mass_gravity_type, "Delfi-n3Xt", "Venus"
    ),
    propagation_setup.dependent_variable.single_acceleration_norm(
        propagation_setup.acceleration.spherical_harmonic_gravity_type, "Delfi-n3Xt", "Earth"
    ),
    propagation_setup.dependent_variable.single_acceleration_norm(
        propagation_setup.acceleration.aerodynamic_type, "Delfi-n3Xt", "Earth"
    ),
    propagation_setup.dependent_variable.single_acceleration_norm(
        propagation_setup.acceleration.radiation_pressure_type, "Delfi-n3Xt", "Sun"
    )
]
